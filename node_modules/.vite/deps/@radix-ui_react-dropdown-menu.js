...
function createCollection(name) {
  ...
  const CollectionProvider = __name6((props) => {
...
var DirectionProvider = __name7((props) => {
...
var DismissableLayer = React9.forwardRef(
  ...
  __name9(function DismissableLayer2(props, forwardedRef) {
    const {
    ...
    React9.useEffect(() => {
      const handleUpdate = __name9(() => force({}), "handleUpdate");
...
var DismissableLayerBranch = React9.forwardRef(__name9(function DismissableLayerBranch2(props, forwardedRef) {
  const context = React9.useContext(DismissableLayerContext);
...
var IS_TRUE = __name9(() => true, "IS_TRUE");
function usePointerDownOutside(onPointerDownOutside, args) {
  ...
  React9.useEffect(() => {
    ...
    const handlePointerDown = __name9((event) => {
  ...
  return {
    ...
    onPointerDownCapture: __name9(() => isPointerInsideReactTreeRef.current = true, "onPointerDownCapture")
  };
}
...
function useFocusOutside(onFocusOutside, ownerDocument = globalThis == null ? void 0 : globalThis.document) {
  ...
  React9.useEffect(() => {
    const handleFocus = __name9((event) => {
  ...
  return {
    onFocusCapture: __name9(() => isFocusInsideReactTreeRef.current = true, "onFocusCapture"),
    onBlurCapture: __name9(() => isFocusInsideReactTreeRef.current = false, "onBlurCapture")
  };
}
...
__name10(FocusGuards, "FocusGuards");
...
__name10(useFocusGuards, "useFocusGuards");
...
__name10(createFocusGuard, "createFocusGuard");
...
var FocusScope = React11.forwardRef(
  __name11(function FocusScope2(props, forwardedRef) {
    const {
      loop = false,
      trapped = false,
...
var Arrow = React14.forwardRef(
  __name13(function Arrow2(props, forwardedRef) {
...
var PopperAnchor = React16.forwardRef(
  __name15(function PopperAnchor2(props, forwardedRef) {
...
var PopperContent = React16.forwardRef(
  __name15(function PopperContent2(props, forwardedRef) {
    ...
    const { refs, floatingStyles, placement, isPositioned, middlewareData } = useFloating({
      ...
      whileElementsMounted: __name15((...args) => {
      ...
      middleware: [
        ...
        size3({
          ...detectOverflowOptions,
          apply: __name15(({ elements, rects, availableWidth, availableHeight }) => {
...
var PopperArrow = React16.forwardRef(
  __name15(function PopperArrow2(props, forwardedRef) {
...
var transformOrigin = __name15((options) => ({
...
var Portal = React17.forwardRef(
  __name16(function Portal2(props, forwardedRef) {
    var _a2;
...
function usePresence(present) {
  ...
  useLayoutEffect2(() => {
    if (node) {
      ...
      const handleAnimationEnd = __name17((event) => {
      ...
      const handleAnimationStart = __name17((event) => {
...
__name17(getElementRef, "getElementRef");
...
function useIsHydrated() {
  const [isHydrated, setIsHydrated] = React19.useState(_isHydrated);
  React19.useEffect(() => {
    if (!_isHydrated) {
      _isHydrated = true;
      setIsHydrated(true);
...
__name18(useIsHydratedModern, "useIsHydratedModern");
...
var RovingFocusGroup = React20.forwardRef(
  // blank line to reduce diff noise
  __name19(function RovingFocusGroup2(props, forwardedRef) {
...
var RovingFocusGroupImpl = React20.forwardRef(__name19(function RovingFocusGroupImpl2(props, forwardedRef) {
  const {
...
var RovingFocusGroupItem = React20.forwardRef(
  // blank line to reduce diff noise
  __name19(function RovingFocusGroupItem2(props, forwardedRef) {
    const {
      __scopeRovingFocusGroup,
      focusable = true,
      active = false,
...
__name19(getDirectionAwareKey, "getDirectionAwareKey");
...
__name19(getFocusIntent, "getFocusIntent");
...
__name19(focusFirst2, "focusFirst");
function wrapArray(array, startIndex) {
  return array.map((_, index2) => array[(startIndex + index2) % array.length]);
}
__name19(wrapArray, "wrapArray");
...
var Menu = __name20((props) => {
  ...
  const direction = useDirection(dir);
  React34.useEffect(() => {
    const handleKeyDown = __name20(() => {
      isUsingKeyboardRef.current = true;
      document.addEventListener("pointerdown", handlePointer, { capture: true, once: true });
      document.addEventListener("pointermove", handlePointer, { capture: true, once: true });
    }, "handleKeyDown");
    const handlePointer = __name20(() => isUsingKeyboardRef.current = false, "handlePointer");
  ...
  React34.useEffect(() => {
    ...
    const handleBlur = __name20(() => handleOpenChange(false), "handleBlur");
...
var MenuAnchor = React34.forwardRef(
  __name20(function MenuAnchor2(props, forwardedRef) {
...
var MenuContent = React34.forwardRef(
  __name20(function MenuContent2(props, forwardedRef) {
...
var MenuRootContentModal = React34.forwardRef(
  // blank line to reduce diff noise
  __name20(function MenuRootContentModal2(props, forwardedRef) {
    const context = useMenuContext(CONTENT_NAME2, props.__scopeMenu);
...
var MenuRootContentNonModal = React34.forwardRef(__name20(function MenuRootContentNonModal2(props, forwardedRef) {
  const context = useMenuContext(CONTENT_NAME2, props.__scopeMenu);
  return (0, import_jsx_runtime12.jsx)(
    MenuContentImpl,
    {
...
var MenuContentImpl = React34.forwardRef(
  // blank line to reduce diff noise
  __name20(function MenuContentImpl2(props, forwardedRef) {
    const {
      __scopeMenu,
      loop = false,
      trapFocus,
    ...
    const handleTypeaheadSearch = __name20((key) => {
      var _a2, _b;
      ...
      __name20((function updateSearch(value) {
...
var MenuGroup = React34.forwardRef(
  __name20(function MenuGroup2(props, forwardedRef) {
...
var MenuLabel = React34.forwardRef(
  __name20(function MenuLabel2(props, forwardedRef) {
...
var MenuItem = React34.forwardRef(
  // blank line to reduce diff noise
  __name20(function MenuItem2(props, forwardedRef) {
...
var MenuItemImpl = React34.forwardRef(
  __name20(function MenuItemImpl2(props, forwardedRef) {
...
var MenuCheckboxItem = React34.forwardRef(
  // blank line to reduce diff noise
  __name20(function MenuCheckboxItem2(props, forwardedRef) {
...
var [RadioGroupProvider, useRadioGroupContext] = createMenuContext(
  RADIO_GROUP_NAME,
  { value: void 0, onValueChange: __name20(() => {
  }, "onValueChange") }
);
var MenuRadioGroup = React34.forwardRef(
  __name20(function MenuRadioGroup2(props, forwardedRef) {
...
var MenuRadioItem = React34.forwardRef(
  __name20(function MenuRadioItem2(props, forwardedRef) {
...
var MenuItemIndicator = React34.forwardRef(
  // blank line to reduce diff noise
  __name20(function MenuItemIndicator2(props, forwardedRef) {
...
var MenuSeparator = React34.forwardRef(
  __name20(function MenuSeparator2(props, forwardedRef) {
...
var MenuArrow = React34.forwardRef(
  __name20(function MenuArrow2(props, forwardedRef) {
    const { __scopeMenu, ...arrowProps } = props;
    const popperScope = usePopperScope(__scopeMenu);
    return (0, import_jsx_runtime12.jsx)(Arrow3, { ...popperScope, ...arrowProps, ref: forwardedRef });
  }, "MenuArrow")
);
var SUB_NAME = "MenuSub";
var [MenuSubProvider, useMenuSubContext] = createMenuContext(SUB_NAME);
var MenuSub = __name20((props) => {
...
var MenuSubTrigger = React34.forwardRef(
  __name20(function MenuSubTrigger2(props, forwardedRef) {
...
var MenuSubContent = React34.forwardRef(
  __name20(function MenuSubContent2(props, forwardedRef) {
    const portalContext = usePortalContext(CONTENT_NAME2, props.__scopeMenu);
...
__name20(getOpenState, "getOpenState");
function isIndeterminate(checked) {
  return checked === "indeterminate";
}
__name20(isIndeterminate, "isIndeterminate");
function getCheckedState(checked) {
  return isIndeterminate(checked) ? "indeterminate" : checked ? "checked" : "unchecked";
}
__name20(getCheckedState, "getCheckedState");
...
__name20(focusFirst3, "focusFirst");
function wrapArray2(array, startIndex) {
  return array.map((_, index2) => array[(startIndex + index2) % array.length]);
}
__name20(wrapArray2, "wrapArray");
...
__name20(getNextMatch, "getNextMatch");
...
__name20(isPointInPolygon, "isPointInPolygon");
function isPointerInGraceArea(event, area) {
  if (!area) return false;
  const cursorPos = { x: event.clientX, y: event.clientY };
  return isPointInPolygon(cursorPos, area);
}
__name20(isPointerInGraceArea, "isPointerInGraceArea");
function whenMouse(handler) {
  return (event) => event.pointerType === "mouse" ? handler(event) : void 0;
}
__name20(whenMouse, "whenMouse");
var Root32 = Menu;
...
var DropdownMenu = __name21((props) => {
  const {
    __scopeDropdownMenu,
    children,
    dir,
...
var DropdownMenuTrigger = React35.forwardRef(
  // blank line to reduce diff noise
  __name21(function DropdownMenuTrigger2(props, forwardedRef) {
...
var DropdownMenuPortal = __name21((props) => {
...
var DropdownMenuContent = React35.forwardRef(
  // blank line to reduce diff noise
  __name21(function DropdownMenuContent2(props, forwardedRef) {
...
var DropdownMenuGroup = React35.forwardRef(
  // blank line to reduce diff noise
  __name21(function DropdownMenuGroup2(props, forwardedRef) {
...
var DropdownMenuLabel = React35.forwardRef(
  // blank line to reduce diff noise
  __name21(function DropdownMenuLabel2(props, forwardedRef) {
...
var DropdownMenuItem = React35.forwardRef(
  // blank line to reduce diff noise
  __name21(function DropdownMenuItem2(props, forwardedRef) {
    const { __scopeDropdownMenu, ...itemProps } = props;
    const menuScope = useMenuScope(__scopeDropdownMenu);
    return (0, import_jsx_runtime13.jsx)(Item2, { ...menuScope, ...itemProps, ref: forwardedRef });
  }, "DropdownMenuItem")
);
var DropdownMenuCheckboxItem = React35.forwardRef(__name21(function DropdownMenuCheckboxItem2(props, forwardedRef) {
  const { __scopeDropdownMenu, ...checkboxItemProps } = props;
  const menuScope = useMenuScope(__scopeDropdownMenu);
  return (0, import_jsx_runtime13.jsx)(CheckboxItem, { ...menuScope, ...checkboxItemProps, ref: forwardedRef });
}, "DropdownMenuCheckboxItem"));
var DropdownMenuRadioGroup = React35.forwardRef(__name21(function DropdownMenuRadioGroup2(props, forwardedRef) {
  const { __scopeDropdownMenu, ...radioGroupProps } = props;
  const menuScope = useMenuScope(__scopeDropdownMenu);
  return (0, import_jsx_runtime13.jsx)(RadioGroup, { ...menuScope, ...radioGroupProps, ref: forwardedRef });
}, "DropdownMenuRadioGroup"));
var DropdownMenuRadioItem = React35.forwardRef(__name21(function DropdownMenuRadioItem2(props, forwardedRef) {
  const { __scopeDropdownMenu, ...radioItemProps } = props;
  const menuScope = useMenuScope(__scopeDropdownMenu);
  return (0, import_jsx_runtime13.jsx)(RadioItem, { ...menuScope, ...radioItemProps, ref: forwardedRef });
}, "DropdownMenuRadioItem"));
var DropdownMenuItemIndicator = React35.forwardRef(__name21(function DropdownMenuItemIndicator2(props, forwardedRef) {
  const { __scopeDropdownMenu, ...itemIndicatorProps } = props;
  const menuScope = useMenuScope(__scopeDropdownMenu);
  return (0, import_jsx_runtime13.jsx)(ItemIndicator, { ...menuScope, ...itemIndicatorProps, ref: forwardedRef });
}, "DropdownMenuItemIndicator"));
var DropdownMenuSeparator = React35.forwardRef(__name21(function DropdownMenuSeparator2(props, forwardedRef) {
...
var DropdownMenuArrow = React35.forwardRef(
  // blank line to reduce diff noise
  __name21(function DropdownMenuArrow2(props, forwardedRef) {
    const { __scopeDropdownMenu, ...arrowProps } = props;
    const menuScope = useMenuScope(__scopeDropdownMenu);
    return (0, import_jsx_runtime13.jsx)(Arrow22, { ...menuScope, ...arrowProps, ref: forwardedRef });
  }, "DropdownMenuArrow")
);
var DropdownMenuSub = __name21((props) => {
...
var DropdownMenuSubTrigger = React35.forwardRef(__name21(function DropdownMenuSubTrigger2(props, forwardedRef) {
  const { __scopeDropdownMenu, ...subTriggerProps } = props;
  const menuScope = useMenuScope(__scopeDropdownMenu);
  return (0, import_jsx_runtime13.jsx)(SubTrigger, { ...menuScope, ...subTriggerProps, ref: forwardedRef });
}, "DropdownMenuSubTrigger"));
var DropdownMenuSubContent = React35.forwardRef(__name21(function DropdownMenuSubContent2(props, forwardedRef) {
